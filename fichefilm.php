...
<main>
    <section id="article-film">
        <div class="container">
            ...
            if(isset($_POST['validate']) && $_SESSION['id'] == $data['userid']) {
                $filmId = $data['id'];
                    ...
                    <form action="" class="article__content" method="POST" style="position: relative; display: flex; flex-direction: column; width: 100%; gap: 1rem;"> 
                        ...
                        <?php if(isset($_SESSION['id'])) : ?>
                            <?php if($_SESSION['id'] == $data['userid']): ?>
                                <div style="display: flex; gap: 5px; position: absolute; top: 0; right: 0;">
            ...
            <?php else : ?>
                <div class="article">
                    ...
                    <div class="article__content" style="width: 100%;"> 
                        ...
                        <?php if(isset($_SESSION['id'])) : ?>
                            <?php if($_SESSION['id'] == $data['userid']) : ?>
                                <form action="fichefilm.php?id=<?= $data['id'] ?>" method="POST">
